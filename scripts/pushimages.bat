...
echo "pushing image helloworld"
%CONTAINER_RUNTIME% tag helloworld %REGISTRY_URL%/%REGISTRY_NAMESPACE%/helloworld
%CONTAINER_RUNTIME% push %REGISTRY_URL%/%REGISTRY_NAMESPACE%/helloworld
